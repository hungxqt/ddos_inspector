...
alias ddos-metrics='cat $DDOS_PROJECT_DIR/data/ddos_inspector_stats'

echo "🛡️  DDoS Inspector aliases loaded!"
echo ""
...
echo ""
echo "💡 Key difference:"
echo "   ddos-down      = Preserves your Grafana/Kibana configs ✅"
echo "   ddos-down-full = Removes all configs (back to defaults) ⚠️"