...
uninstall_dependencies() {
    ...
    echo "   ✅ Snort 3 Dependencies (libdaq, libdnet, LuaJIT)"
    echo "   ✅ Development Libraries (OpenSSL, PCAP, PCRE2)"
    echo "   ✅ Testing Framework (Google Test)"
    echo "   ✅ Docker & Docker Compose"
    echo "   ✅ nftables firewall"
    echo "   ✅ Network testing tools"
    echo "   ✅ System user (ddos-inspector)"
