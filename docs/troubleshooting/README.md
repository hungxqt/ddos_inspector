...
cat /var/log/ddos_inspector/metrics.log | grep packets_per_second
...
grep "entropy" /var/log/ddos_inspector/metrics.log
...
cat /var/log/ddos_inspector/metrics.log | grep baseline
...
sudo cp /var/log/ddos_inspector/metrics.log /var/log/ddos_inspector/metrics.log.backup
sudo tar -czf /tmp/snort-logs-$(date +%Y%m%d).tar.gz /var/log/snort/

# Reset statistics
sudo rm -f /var/log/ddos_inspector/metrics.log
sudo systemctl restart snort-ddos

# Restore from backup if needed
sudo cp /var/log/ddos_inspector/metrics.log.backup /var/log/ddos_inspector/metrics.log
```
...
# Metrics
cp /var/log/ddos_inspector/metrics.log "$DIAG_DIR/" 2>/dev/null
